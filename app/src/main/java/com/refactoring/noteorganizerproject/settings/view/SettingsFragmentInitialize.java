...
import com.refactoring.noteorganizerproject.settings.help_activity.HelpActivity;
import com.refactoring.noteorganizerproject.settings.presenter.SettingsPresenter;

public class SettingsFragmentInitialize extends Fragment {
    View root;
